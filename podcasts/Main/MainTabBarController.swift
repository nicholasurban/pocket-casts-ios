...
private extension MainTabBarController {
    ...
    func showToast(for bookmark: Bookmark, source: BookmarkAnalyticsSource) {
        ...
        let action = Toast.Action(title: L10n.changeBookmarkTitle) { [weak self] in
            ...
            let controller = BookmarkEditTitleViewController(manager: bookmarkManager, bookmark: bookmark, state: .updating, style: .themed, source: source, onDismiss: { [weak self] updatedTitle, _ in
